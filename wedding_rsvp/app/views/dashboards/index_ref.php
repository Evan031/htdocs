...
$attending_values = [];
$attending_names = [];
$attending_graph = (array)($data['guest_graph'][0]);
...
<script>
    var xValues = <?php echo json_encode($attending_names); ?>;
    var yValues = <?php echo json_encode($attending_values); ?>;
    var barColors = [
        'rgba(255, 99, 132, 0.2)',
        'rgba(255, 159, 64, 0.2)',
    ];
