            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col text-center">
                        <h3 class="mb-4">Select your main</h3>
                        <div id="food_options" class="main_menu_text mb-5">
                            <h5>Your options are</h5>
                            <p>1. Charred Lemon Roasted Chicken</p>
                            <p>2. BBQ Bourbon Braised Beef Short Rib</p>
                            <p>3. Creamy Gnocchi with Roasted Butternut Walnut and Pecorino</p>
                            <h5>Sides are mascarpone mashed potatoes and saut&eacute;ed vegetables</h5>
                        </div>
